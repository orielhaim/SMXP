  ...
  return new Elysia({ prefix: "/.smxp/delegations" })
    ...
    .post(
      ...
      },
      {
        ...
        detail: { tags: ["Delegations"], summary: "Grant a delegation to another address" },
      },
    )
    ...
    .get(
      ...
      {
        detail: { tags: ["Delegations"], summary: "List delegations granted by the authenticated address" },
      },
    )
    ...
    .get(
      ...
      {
        detail: { tags: ["Delegations"], summary: "List delegations granted TO the authenticated address" },
      },
    )
