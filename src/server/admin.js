  ...
  return (
    new Elysia({ prefix: "/.smxp/admin" })
      ...
      .delete(
        ...
        {
          params: t.Object({ domain: t.String() }),
          detail: { tags: ["Admin"], summary: "Delete a domain and all its addresses" },
        },
      )
      ...
      .get(
        ...
        },
        {
          ...
          detail: { tags: ["Admin"], summary: "List addresses, optionally filtered by domain" },
        },
      )
      ...
      .post(
        ...
        },
        {
          body: t.Object({
            ...
            mode: t.Optional(
              t.Union([t.Literal("inbox"), t.Literal("forward")]),
            ),
            password: t.Optional(
          ...
          detail: { tags: ["Admin"], summary: "Create an inbox or forward address" },
        },
      )
      ...
      .get(
        ...
        },
        {
          ...
          detail: { tags: ["Admin"], summary: "Get an address by domain and alias" },
        },
      )
